...
PLAYERS_LIST = (
    # red bird
    (
        D+'assets/sprites/redbird-upflap.png',
        D+'assets/sprites/redbird-midflap.png',
        D+'assets/sprites/redbird-downflap.png',
    ),
    # blue bird
    (
        # amount by which base can maximum shift to left
        D+'assets/sprites/bluebird-upflap.png',
        D+'assets/sprites/bluebird-midflap.png',
        D+'assets/sprites/bluebird-downflap.png',
    ),
    # yellow bird
    (
        D+'assets/sprites/yellowbird-upflap.png',
        D+'assets/sprites/yellowbird-midflap.png',
        D+'assets/sprites/yellowbird-downflap.png',
    ),
)

# list of backgrounds
BACKGROUNDS_LIST = (
    D+'assets/sprites/background-day.png',
    D+'assets/sprites/background-night.png',
)

# list of pipes
PIPES_LIST = (
    D+'assets/sprites/pipe-green.png',
    D+'assets/sprites/pipe-red.png',
)
...
def main():
    ...
    IMAGES['message'] = pygame.image.load(D+'assets/sprites/message.png').convert_alpha()
    # base (ground) sprite
    IMAGES['base'] = pygame.image.load(D+'assets/sprites/base.png').convert_alpha()
    ...
    SOUNDS['die'] = pygame.mixer.Sound(D+'assets/audio/die' + soundExt)
    SOUNDS['hit'] = pygame.mixer.Sound(D+'assets/audio/hit' + soundExt)
    SOUNDS['point'] = pygame.mixer.Sound(D+'assets/audio/point' + soundExt)
    SOUNDS['swoosh'] = pygame.mixer.Sound(D+'assets/audio/swoosh' + soundExt)
    SOUNDS['wing'] = pygame.mixer.Sound(D+'assets/audio/wing' + soundExt)
